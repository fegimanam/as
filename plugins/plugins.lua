...
return {
  ...
  usage = {
      moderator = {
          "/plugs di [plugin] gp : disable plugin only this chat.",
          "/plugs en [plugin] gp : enable plugin only this chat.",
          },
      sudo = {
          "/plugs : list all plugins.",
          "/plugs en [plugin] : enable plugin.",
          "/plugs di [plugin] : disable plugin.",
          "/plugs re : reloads all plugins." },
          },
  patterns = {
    "^/plugs $",
    "^/plugs? (en) ([%w_%.%-]+)$",
